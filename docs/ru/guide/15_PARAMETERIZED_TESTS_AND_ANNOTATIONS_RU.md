...
Для сборки макросов используйте зафиксированный toolchain проекта: Xcode 26.5, Swift 6.3.2 и SwiftSyntax 603.0.2. Минимальная версия запуска приложения остаётся iOS 15. Обычные тесты и runtime API работают без применения макросов.
